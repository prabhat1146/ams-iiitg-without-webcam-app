...
function EmailVerificationLinkForFaculty() {
    ...
    useEffect(() => {
        ...
        const url = `${BASEURL}/verification/SendEmailVerificationLinkForFaculty`;
...
export default EmailVerificationLinkForFaculty;
